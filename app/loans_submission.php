			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="loans-text">
						<h2>Submit the relevent documents and wait for your results </h2>
						<ul>
							<li>Your CPF contribution for the past year</li>
							<li>Your 3 Months Payslip</li>
		...
		<div class="container">
			<div class="row">
				<div class="col-xl-9 col-lg-9">
					<h2>Upload the relevent documents</h2>
				</div>
				<div class="form-group">
					...
					<button type='button' class="w3-button w3-red" id='scratchcard' onclick="upload()">Upload
				</div>
				</div>
			</div>
		</div>
