				...
				<div class="col-lg-6">
					<form class="hero-form" action='index.php' method='POST'>
						<?php
							printErrors();
						?>
						<input type="text" name='nric' placeholder="Your NRIC">
						<input type="password" name='password' placeholder="Password">
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </p>
						<button class="site-btn" name=login>Login</button><button class="site-btn" name='register'>Register New Account</button>
