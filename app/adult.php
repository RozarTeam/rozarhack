...
if(isset($_POST['name'])&&isset($_POST['date'])){
    ...
    $addresult=$adultDAO->add($username, $name, $newdate);
    
}
?>
<html>
<head>
    <title>Rozar Banking | Financial Planning for Adults</title>
	<meta charset="UTF-8">
		...
		<div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <a href="financialplanner.php">Return</a>
                </div>
            </div>
        </div>
...
<?php
    if (isset($addresult)){
    if($addresult){
        echo"<script>alert('Appointment has been booked.');window.location.href='financialplanner.php';</script>";
        exit();
    }
    else{
